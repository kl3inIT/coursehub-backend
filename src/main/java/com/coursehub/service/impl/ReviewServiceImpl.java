...
//        if (reviewRepository.existsByUserEntityIdAndCourseEntityIdAndIsActiveTrue(userId, requestDTO.getCourseId())) {
...
//        return reviewRepository.existsByUserEntityIdAndCourseEntityIdAndIsActiveTrue(userId, courseId);
//    }
} 