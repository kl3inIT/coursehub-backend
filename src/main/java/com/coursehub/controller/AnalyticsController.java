...
public class AnalyticsController {
    ...
    public ResponseEntity<ResponseGeneral<Page<CategoryAnalyticsDetailResponseDTO>>> getCategoryAnalyticsDetails(
            ...
            @RequestParam(defaultValue = "revenue,asc") String[] sort
    ...
    public ResponseEntity<ResponseGeneral<Page<StudentAnalyticsDetailResponseDTO>>> getStudentAnalyticsDetails(
            @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") Date startDate,
            @RequestParam(required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") Date endDate,
            @RequestParam(required = false) String range,
            @RequestParam(defaultValue = "0") int page,
        ...
        log.info("Fetching student analytics details - page: {}, size: {}", page, size);
        ...
        Page<StudentAnalyticsDetailResponseDTO> studentAnalyticsPage =
                analyticsService.getStudentAnalyticsDetails(startDate, endDate, pageable);

        ResponseGeneral<Page<StudentAnalyticsDetailResponseDTO>> response = new ResponseGeneral<>();
        response.setData(studentAnalyticsPage);
        response.setMessage(SUCCESS);
